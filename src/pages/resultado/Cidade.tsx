...
import { useCidade, useEbitda } from '../../api/queriesResultado'
import { Carregando, ErroCarga } from '../../components/Estado'
import { useCrumbs } from '../../state/CrumbsResultado'
import { brl, inteiro, pct, VAZIO } from '../../lib/formato'
import { DataTable, KpiCard, KpiGrid, Painel } from '../../components/resultado/pecas'
import {
  GraficoCascata,
  GraficoCobertura,
  GraficoEbitda,
} from '../../components/resultado/graficos'
import type { Paridade, SistemaLinha } from '../../domain/resultado'
