...
import { useCidades, useEbitda, usePainel, useRunMeta } from '../../api/queriesResultado'
import { Carregando, ErroCarga } from '../../components/Estado'
import { useCrumbs } from '../../state/CrumbsResultado'
import { brl, brlMi, deTotal, inteiro, pct } from '../../lib/formato'
import { DataTable, KpiCard, KpiGrid } from '../../components/resultado/pecas'
import {
  ...
  GraficoHistograma,
  GraficoObrasPorAno,
} from '../../components/resultado/graficos'
import type { CidadeLinha } from '../../domain/resultado'
