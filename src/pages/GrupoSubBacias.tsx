...
import { CascadeTree, type TreeNode } from '../components/CascadeTree'
import { RecordSheet } from '../components/RecordSheet'
import { DbCard, DbField, DbFieldGrid } from '../components/DbCard'
...
import { chipPendencias } from '../lib/chip'
import { useApp } from '../state/AppContext'
import { useCadastro } from '../state/CadastroContext'
import { useSubBacias } from '../api/queries'
import { useSalvarSubBacia } from '../api/mutations'
import { useErroAoSalvar } from '../state/erroAoSalvar'
import { chaveSub } from '../state/fichas'
import { mkObras, type Obra, type SubBaciaParams, type SubBaciaDb } from '../domain/subbacia'
import { CAMPOS_DB, camposParametros } from '../domain/baseComercial'
import { NotaDaRegua } from '../components/NotaDaRegua'
import { NotaIndustrial } from '../components/NotaIndustrial'
import { CamposPopulacao } from './CamposPopulacao'
...
export function GrupoSubBacias() {
  ...
  const salvarM = useSalvarSubBacia(unidadeId, {
    onSalva: ({ subId, ficha }) => marcarSalva(chaveSub(subId), ficha),
  })
