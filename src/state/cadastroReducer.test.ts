...
import type { SubBacia, SupNode } from '../domain/subbacia'
import type { Cidade, Fator, Meta } from '../domain/contrato'
import type { Ete } from '../domain/ete'
import { CTS_CAMPOS, novaCts, type Cts, type ParCts } from '../domain/cts'
import {
  derive,
  initialState,
  reducer,
...
import { assinatura, chaveCts, chaveSub, fichaSub, hierAlterada, sujas } from './fichas'
import { BASE_OBRAS } from '../domain/subbacia'
import { BASE_OBRAS_CTS } from '../domain/cts'
