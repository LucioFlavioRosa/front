...
import { useContrato, useCts, useEtes, useHierarquia, useSubBacias } from '../api/queries'
import {
  subPend,
  type Obra,
  type SubBacia,
  type SubBaciaDb,
  type SubBaciaParams,
} from '../domain/subbacia'
import { cidadePend, type Cidade, type Fator, type Meta } from '../domain/contrato'
import { etePend, type Ete } from '../domain/ete'
import type { UnidReg } from '../domain/hierarquia'
import { ctsPend, type Cts, type ParCts } from '../domain/cts'
import type { Regua } from '../domain/baseComercial'
import {
  derive,
  initialState,
  reducer,
...
import type { FichaCidade, FichaCts, FichaEte, FichaSubBacia } from '../api/escrita'
