...
import { reguaDe, type Regua } from '../domain/baseComercial'
import { g2Pend, type Cidade, type Fator, type Meta } from '../domain/contrato'
import { etePend, isNova, type Ete } from '../domain/ete'
import { BASE_OBRAS_CTS, camposDaCts, ctsPend, type Cts, type ParCts } from '../domain/cts'
import type { CidadeH, SistemaH, Superintendencia, TopoRow, UnidReg } from '../domain/hierarquia'
import {
  assinatura,
  chaveCidade,
  chaveCts,
