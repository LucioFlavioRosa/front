...
import { cidadePend, g2Pend, type ContratoPayload } from './contrato'
import { capacidadeOciosa, etePend, isNova, type Ete } from './ete'
import ctsFx from '../mocks/fixtures/cts.json'
import { BASE_OBRAS_CTS, CTS_CAMPOS, ctsPend, mkObrasCts, novaCts, type Cts } from './cts'
