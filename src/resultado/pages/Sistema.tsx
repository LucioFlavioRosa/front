...
import { useTopologia } from '@/resultado/api/queries'
import { Carregando, ErroCarga } from '@/comum/components/Estado'
import { useCrumbs } from '@/resultado/state/Crumbs'
import { brl, inteiro, vazao as fmtVazao } from '@/resultado/lib/formato'
import { EteCard, LegendaTopologia, NodeCard } from '@/resultado/components/NodeCard'
import type { NoTopologia } from '@/resultado/domain/resultado'
