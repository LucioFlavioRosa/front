...
import etesFx from './fixtures/etes.json'
import estrutura from './fixtures/estrutura.json'
import ctsFx from './fixtures/cts.json'
import type { Unidade } from '../domain/types'
import { camposDaSub, cidadePorSub, subPend, type SubBacia } from '../domain/subbacia'
import { g2Pend, type ContratoPayload } from '../domain/contrato'
import { etePend, isNova, type Ete } from '../domain/ete'
import { camposDaCts, ctsPend, type Cts } from '../domain/cts'
